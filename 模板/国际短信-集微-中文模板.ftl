...
<head>
    ...
    <style lang="less" scoped>
        ...
        .bg {
            ...
            background-image: url('https://s21.ax1x.com/2024/08/18/pAPV6BQ.png');
    ...
    <body>
        <div id="app">
            <div class="bg" style="height: 1122.5px;">
                <#if i==1>
                    <img src="https://s21.ax1x.com/2024/08/19/pAPQbfH.png" alt="" height="180px" width="100%">
                    ...
                    <img src="https://s21.ax1x.com/2024/08/19/pAPJf6H.png" alt="" width="100%">
                ...
                <#if i==lasePage>
                    <div class="heji">
                        <img src="https://s21.ax1x.com/2024/08/19/pAP8l9g.png" alt="" width="">
