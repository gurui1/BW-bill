...
<head>
    ...
    <style lang="less" scoped>
        ...
        .bg {
            ...
            background-image: url('https://s21.ax1x.com/2024/08/18/pAPVMfx.png');
    ...
    <body>
        <div id="app">
            <div class="bg" style="height: 1122.5px;">
                <#if i==1>
                    <img src="https://s21.ax1x.com/2024/08/18/pAPVB1f.png" alt="" height="180px" width="100%">
                    ...
                    <img src="https://s21.ax1x.com/2024/08/19/pAPQjXt.png" alt="" width="100%">
                ...
                <#if i!=1>
                    <img src="https://s21.ax1x.com/2024/08/19/pAP8KN8.png" alt="" width="100%">
                </#if>
                <#if i<=totalPage>
                ...
                <#if i==lasePage>
                    <div class="heji">
                        <img src="https://s21.ax1x.com/2024/08/19/pAPQO1A.png" alt="" width="">
